    ...
    async def validate_question(self, user_input: str, validation_prompt: str) -> Tuple[Optional[str], Optional[str]]:
        ...
        try:
            ...
            if "composición del equipo" in validation_prompt.lower() or "equipo de trabajo" in validation_prompt.lower():
                ...
                individual_keywords = ["no tengo equipo", "proyecto solitario", "proyecto individual", "emprender solo", "trabajo solo", "sin equipo", "trabajo individual"]
            ...
            response = await self.client.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "Eres un validador experto que formatea información de manera precisa y proporciona mensajes de error útiles."},
